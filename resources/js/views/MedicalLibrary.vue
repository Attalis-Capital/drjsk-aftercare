...
const demoLibraryItems: LibraryItem[] = [
    {
        id: 'demo-woundcare',
        title: 'Caring for Your Surgical Wound at Home',
        source_type: 'url_scrape',
        source_url: 'https://www.healthdirect.gov.au/wound-care',
        processing_status: 'completed',
        processing_error: null,
        ai_analysis: {
            title: 'Caring for Your Surgical Wound at Home',
            summary: 'Patient guidance on caring for a surgical wound after an operation. Covers keeping the wound clean and dry, recognising normal healing versus signs of infection, and when to contact the practice.',
            key_findings: [
                'Mild swelling and bruising around a wound are expected in the first weeks and settle gradually',
                'A small amount of clear fluid can be normal; increasing redness, warmth, or cloudy discharge may signal infection',
                'Keeping the wound clean, dry, and supported helps it heal well and reduces scarring',
            ],
            recommendations: [
                'Follow your surgeon\'s dressing instructions and avoid disturbing the wound early',
                'Watch for signs of infection: spreading redness, increasing pain, warmth, or fever',
                'Contact the practice on (02) 9369 2800 if you are concerned about your wound',
            ],
            publication_info: { publisher: 'Healthdirect Australia', year: 2025 },
            categories: {
                medical_topics: ['Wound Care', 'Post-operative Recovery', 'Infection Prevention'],
                evidence_level: 'B',
                evidence_description: 'Government-reviewed patient education material',
                specialty_areas: ['Plastic Surgery', 'General Practice'],
                document_type: 'Patient Education',
                icd10_codes: ['Z48.0'],
            },
            patient_relevance: {
                relevance_score: 0.95,
                relevance_explanation: 'Directly relevant to your recovery. This resource helps you tell normal healing from the signs that need review.',
                matching_conditions: ['Post-operative wound care'],
                matching_medications: ['Cephalexin'],
                actionable_insights: [
                    'Keeping the wound clean and dry supports healing while you finish your antibiotic course',
                    'Knowing the warning signs helps you act early if something changes',
                ],
            },
            verification: { verified: true, issues: [], confidence: 'high' },
            pipeline_version: '1.0',
            processed_at: '2026-06-25T14:00:00Z',
        },
        created_at: '2026-06-25T14:00:00Z',
        updated_at: '2026-06-25T14:00:00Z',
    },
    {
        id: 'demo-vte-prophylaxis',
        title: 'Preventing Blood Clots After Surgery',
        source_type: 'url_scrape',
        source_url: 'https://www.healthdirect.gov.au/deep-vein-thrombosis-dvt',
        processing_status: 'completed',
        processing_error: null,
        ai_analysis: {
            title: 'Preventing Blood Clots After Surgery',
            summary: 'Patient education on reducing the risk of deep vein thrombosis (DVT) after an operation, including gentle movement, hydration, and blood-thinning injections where prescribed.',
            key_findings: [
                'Being less mobile after surgery raises the risk of blood clots in the legs (DVT)',
                'Gentle walking, staying hydrated, and prescribed injections lower this risk',
                'Sudden calf pain and swelling, or breathing difficulty and chest pain, need urgent review',
            ],
            recommendations: [
                'Move around gently and often as your surgeon advises',
                'Take prescribed clot-prevention injections (such as enoxaparin) exactly as directed',
                'Call the practice on (02) 9369 2800 now, or 000 in an emergency, for breathing difficulty or chest pain',
            ],
            publication_info: { publisher: 'Healthdirect Australia', year: 2025 },
            categories: {
                medical_topics: ['DVT Prophylaxis', 'Post-operative Recovery', 'Blood Clot Prevention'],
                evidence_level: 'A',
                evidence_description: 'Guideline-based patient education',
                specialty_areas: ['Plastic Surgery', 'General Practice'],
                document_type: 'Patient Education',
                icd10_codes: ['Z79.01'],
            },
            patient_relevance: {
                relevance_score: 0.9,
                relevance_explanation: 'Relevant while your mobility is reduced after surgery. Explains why gentle movement and prescribed injections matter.',
                matching_conditions: ['Post-operative recovery'],
                matching_medications: ['Enoxaparin'],
                actionable_insights: [
                    'Gentle, regular walking around the house helps keep your blood moving',
                    'Breathing difficulty or chest pain is an urgent warning sign - do not wait',
                ],
            },
            verification: { verified: true, issues: [], confidence: 'high' },
            pipeline_version: '1.0',
            processed_at: '2026-06-25T15:00:00Z',
        },
        created_at: '2026-06-25T15:00:00Z',
        updated_at: '2026-06-25T15:00:00Z',
    },
    {
        id: 'demo-supplement-cessation',
        title: 'Supplements to Stop Before and After Surgery',
        source_type: 'url_scrape',
        source_url: 'https://www.drjsk.com.au',
        processing_status: 'completed',
        processing_error: null,
        ai_analysis: {
            title: 'Supplements to Stop Before and After Surgery',
            summary: 'Practice guidance on supplements that can increase bleeding or bruising around surgery, including fish oil, vitamin E, turmeric, and arnica, and when it is safe to restart them.',
            key_findings: [
                'Some supplements can thin the blood and increase bruising and bleeding around surgery',
                'Fish oil, vitamin E, turmeric, and arnica are commonly paused before an operation',
                'Always tell your surgeon about every supplement and over-the-counter product you take',
            ],
            recommendations: [
                'Stop the supplements your surgeon lists at the advised time before surgery',
                'Do not restart any supplement until your surgeon confirms it is safe',
                'Bring a full list of your medicines and supplements to each appointment',
            ],
            publication_info: { publisher: 'Dr James Southwell-Keely Plastic Surgery', year: 2026 },
            categories: {
                medical_topics: ['Supplement Cessation', 'Bleeding Risk', 'Perioperative Care'],
                evidence_level: 'B',
                evidence_description: 'Practice patient education',
                specialty_areas: ['Plastic Surgery'],
                document_type: 'Patient Education',
                icd10_codes: ['Z51.89'],
            },
            patient_relevance: {
                relevance_score: 0.82,
                relevance_explanation: 'Helps you avoid supplements that could increase bleeding or bruising during your recovery.',
                matching_conditions: ['Perioperative care'],
                matching_medications: [],
                actionable_insights: [
                    'Check any supplement with the practice before restarting it after surgery',
                    'Fish oil, vitamin E, turmeric, and arnica are common ones to pause',
                ],
            },
            verification: { verified: true, issues: [], confidence: 'high' },
            pipeline_version: '1.0',
            processed_at: '2026-06-25T16:00:00Z',
        },
        created_at: '2026-06-25T16:00:00Z',
        updated_at: '2026-06-25T16:00:00Z',
    },
    {
        id: 'demo-scar-management',
        title: 'Looking After Your Scar',
        source_type: 'url_scrape',
        source_url: 'https://www.drjsk.com.au',
        processing_status: 'completed',
        processing_error: null,
        ai_analysis: {
            title: 'Looking After Your Scar',
            summary: 'Patient guidance on caring for surgical scars once wounds have healed, including sun protection, moisturising, massage when advised, and realistic timelines for scars to fade.',
            key_findings: [
                'Scars continue to change and usually fade over 12 to 18 months',
                'Protecting a new scar from the sun helps it settle to a paler colour',
                'Gentle massage and moisturising, once your surgeon advises, can help soften a scar',
            ],
            recommendations: [
                'Keep new scars out of direct sun and use sun protection when outside',
                'Start scar massage and silicone products only once your surgeon says the wound has healed',
                'Be patient - scars take many months to reach their final appearance',
            ],
            publication_info: { publisher: 'Dr James Southwell-Keely Plastic Surgery', year: 2026 },
            categories: {
                medical_topics: ['Scar Management', 'Wound Healing', 'Recovery'],
                evidence_level: 'B',
                evidence_description: 'Practice patient education',
                specialty_areas: ['Plastic Surgery'],
                document_type: 'Patient Education',
            ...
            patient_relevance: {
                relevance_score: 0.8,
                relevance_explanation: 'Relevant as your wounds heal and you begin to think about the appearance of your scars.',
                matching_conditions: ['Post-operative recovery'],
                matching_medications: [],
                actionable_insights: [
                    'Sun protection early on helps your scar fade to a paler colour',
                    'Wait for your surgeon\'s go-ahead before starting massage or silicone',
                ],
            },
            verification: { verified: true, issues: [], confidence: 'high' },
            pipeline_version: '1.0',
            processed_at: '2026-06-25T17:00:00Z',
        },
